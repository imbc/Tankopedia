...
class NationalityController extends Controller
{
    ...
    public function showAction( Request $request )
    {
        ...
        $nationalityRepo = $entityManager->getRepository( 'ImbcTankopediaBundle:Nationality' );
        $tankRepo = $entityManager->getRepository( 'ImbcTankopediaBundle:Tank' );
        if( null === $nationality = $nationalityRepo->findOneBy( array( 'slug' => $request->get( 'slug' )) ))
        {
    ...
    public function editAction( Request $request )
    {
        $edit = false;
        $entityManager = $this->getDoctrine()->getManager();
        $repo = $entityManager->getRepository( 'ImbcTankopediaBundle:Nationality' );
