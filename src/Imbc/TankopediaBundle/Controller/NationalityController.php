...
class NationalityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ImbcTankopediaBundle:Nationality')->findAll();
    ...
    public function createAction(Request $request)
    {
        ...
        $form = $this->createForm(new NationalityType(), $entity);
        $form->bind($request);
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('tankopedia_nationality_show', array('id' => $entity->getId())));
        }

        return $this->render('ImbcTankopediaBundle:Nationality:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ImbcTankopediaBundle:Nationality')->find($id);

        if (!$entity) {
            throw $this->createNotFoundException('Unable to find Nationality entity.');
        }
    ...
    public function editAction($id)
    {
        ...
        $editForm = $this->createForm(new NationalityType(), $entity);
        $deleteForm = $this->createDeleteForm($id);
    ...
    /**
     * Edits an existing Nationality entity.
     *
     */
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('tankopedia_nationality_edit', array('id' => $id)));
        }
    ...
    /**
     * Creates a form to delete a Nationality entity by id.
     *
