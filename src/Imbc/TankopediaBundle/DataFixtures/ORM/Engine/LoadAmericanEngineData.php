...
class LoadAmericanEngineData extends AbstractFixture implements
	...
	public function load(ObjectManager $manager) {
		...
		$engine6 = new Engine('Continental W-670-7', $tier3, $nationality,
				5600, 256, 262, 20, $gazoline);
		$engine6->addTank($tankRepo->getTankByName('M2 Light Tank'));
		$manager->persist($engine6);

		$engine7 = new Engine('Cuiberson T-10204', $tier3, $nationality, 500,
				331, 220, 20, $gazoline);
		$engine7->addTank($tankRepo->getTankByName('M2 Light Tank'));
		$manager->persist($engine7);

		$engine8 = new Engine('Guiberson T-1020-4', $tier3, $nationality, 5000,
				331, 245, 12, $diesel);
		...
		$engine9 = new Engine('Hercules HXE', $tier3, $nationality, 0, 331,
				240, 12, $gazoline);
		$engine9->addTank($tankRepo->getTankByName('MTLS-1G14'));
		$manager->persist($engine9);

		$engine10 = new Engine('Wright Continental R-975C2', $tier3,
				$nationality, 9200, 549, 340, 20, $gazoline);
		...
		$engine11 = new Engine('American LaFrance 312A V-12', $tier4,
				$nationality, 0, 800, 244, 20, $gazoline);
		$engine11->addTank($tankRepo->getTankByName('T1E6'));
		$manager->persist($engine11);

		$engine12 = new Engine('Buick Series 60', $tier4, $nationality, 10400,
				756, 330, 20, $gazoline);
		$engine12->addTank($tankRepo->getTankByName('T49'));
		$manager->persist($engine12);

		$engine13 = new Engine('Continental R-670-5', $tier4, $nationality, 0,
				256, 265, 20, $gazoline);
		$engine13->addTank($tankRepo->getTankByName('T2 Light Tank'));
		$manager->persist($engine13);

		$engine14 = new Engine('Continental R-975-C1', $tier4, $nationality,
				10500, 500, 350, 20, $gazoline);
		...
		$engine15 = new Engine('Lycoming 0-435t', $tier4, $nationality, 0, 256,
				192, 20, $gazoline);
		$engine15->addTank($tankRepo->getTankByName('M22 Locust'));
		$manager->persist($engine15);

		$engine16 = new Engine('Twin Cadillac 42A series', $tier4,
				$nationality, 10350, 530, 320, 20, $gazoline);
		$engine16->addTank($tankRepo->getTankByName('M41'));
		$manager->persist($engine16);

		$engine17 = new Engine('Twin Cadillac 42 series', $tier4, $nationality,
				10350, 530, 320, 20, $gazoline);
		...
		$engine18 = new Engine('Twin Cadillac series 44T4', $tier4,
				$nationality, 8100, 529, 240, 20, $gazoline);
		$engine18->addTank($tankRepo->getTankByName('M37'));
		$engine18->addTank($tankRepo->getTankByName('M41'));
		$manager->persist($engine18);

		$engine19 = new Engine('Wright Continental R-975C1', $tier4,
				$nationality, 11000, 549, 380, 20, $gazoline);
		...
		$engine20 = new Engine('Wright Continental R-975EC2', $tier4,
				$nationality, 10500, 515, 350, 20, $gazoline);
		...
		$engine21 = new Engine('Wright R-975EC2', $tier4, $nationality, 11600,
				515, 400, 20, $gazoline);
		...
		$engine22 = new Engine('2x44E24 V-8 Cadillac', $tier4, $nationality,
				8000, 256, 300, 20, $gazoline);
		$engine22->addTank($tankRepo->getTankByName('M24 Chaffee'));
		$manager->persist($engine22);

		$engine23 = new Engine('Chrysler A57', $tier5, $nationality, 13900,
				570, 440, 20, $gazoline);
		...
		$engine24 = new Engine('Continental AOI-628-1', $tier5, $nationality,
				14000, 498, 340, 20, $gazoline);
		$engine24->addTank($tankRepo->getTankByName('T71'));
		$manager->persist($engine24);

		$engine25 = new Engine('Wright Continental R-975C3', $tier5,
				$nationality, 0, 569, 440, 20, $gazoline);
		$engine25->addTank($tankRepo->getTankByName('Ram-II'));
		$manager->persist($engine25);

		$engine26 = new Engine('GMC 6046', $tier5, $nationality, 13500, 549,
				420, 15, $gazoline);
		...
		$engine27 = new Engine('General Motors 6046', $tier5, $nationality, 0,
				549, 420, 15, $diesel);
		$engine27->addTank($tankRepo->getTankByName('M4A2E4'));
		$manager->persist($engine27);

		$engine28 = new Engine('Wright Continental R-975C4', $tier5,
				$nationality, 13900, 549, 460, 20, $gazoline);
		...
		$engine29 = new Engine('Wright G200 M795C9GC1', $tier5, $nationality,
				22500, 612, 700, 20, $gazoline);
		$engine29->addTank($tankRepo->getTankByName('T1 Heavy Tank'));
		$manager->persist($engine29);

		$engine30 = new Engine('Ford GAF', $tier6, $nationality, 25300, 569,
				440, 20, $gazoline);
		...
		$engine31 = new Engine('Ford GAFM2A1', $tier6, $nationality, 34600,
				569, 510, 20, $gazoline);
		...
		$engine32 = new Engine('Ford GAFM2A2', $tier6, $nationality, 38700,
				569, 530, 20, $gazoline);
		$engine32->addTank($tankRepo->getTankByName('T92'));
		$manager->persist($engine32);

		$engine33 = new Engine('Ford GAF V8', $tier6, $nationality, 0, 569,
				500, 20, $gazoline);
		$engine33->addTank($tankRepo->getTankByName('T26E4 Super Pershing'));
		$manager->persist($engine33);

		$engine34 = new Engine('Wright G2X M781C9GC1', $tier6, $nationality,
				30000, 612, 825, 20, $gazoline);
		$engine34->addTank($tankRepo->getTankByName('T1 Heavy Tank'));
		$engine34->addTank($tankRepo->getTankByName('M6'));
		$manager->persist($engine34);

		$engine35 = new Engine('Continental AOI-628-2', $tier7, $nationality,
				34000, 498, 400, 20, $gazoline);
		$engine35->addTank($tankRepo->getTankByName('T71'));
		$manager->persist($engine35);

		$engine36 = new Engine('Continental AOS-895-1', $tier7, $nationality,
				38500, 256, 500, 20, $gazoline);
		$engine36->addTank($tankRepo->getTankByName('M24 Chaffee'));
		$manager->persist($engine36);

		$engine37 = new Engine('Continental AOS-895-3', $tier7, $nationality,
				31000, 771, 500, 20, $gazoline);
		$engine37->addTank($tankRepo->getTankByName('T69'));
		$manager->persist($engine37);

		$engine38 = new Engine('Ford GAA', $tier7, $nationality, 36000, 569,
				520, 20, $gazoline);
		...
		$engine42 = new Engine('Wright G200 M781C9GC1', $tier7, $nationality,
				47600, 612, 960, 20, $gazoline);
		$engine42->addTank($tankRepo->getTankByName('T1 Heavy Tank'));
		$engine42->addTank($tankRepo->getTankByName('M6'));
		$manager->persist($engine42);

		$engine43 = new Engine('Continental AOSI-895-5', $tier8, $nationality,
				43000, 771, 600, 20, $gazoline);
		$engine43->addTank($tankRepo->getTankByName('T69'));
		$manager->persist($engine43);

		$engine44 = new Engine('Continental AV-1790-1', $tier8, $nationality,
				45000, 569, 704, 20, $gazoline);
		...
		$engine45 = new Engine('Continental AV-1790-3', $tier8, $nationality,
				59000, 569, 800, 20, $gazoline);
		...
		$engine46 = new Engine('GMC Allison V1710-E32', $tier8, $nationality,
				48500, 556, 760, 20, $gazoline);
		$engine46->addTank($tankRepo->getTankByName('T29'));
		$engine46->addTank($tankRepo->getTankByName('T32'));
		$manager->persist($engine46);

		$engine47 = new Engine('AV-1790-5A', $tier9, $nationality, 99000, 569,
				820, 20, $gazoline);
		$engine47->addTank($tankRepo->getTankByName('M46 Patton'));
		$manager->persist($engine47);

		$engine48 = new Engine('Continental AV-1790-3A1', $tier9, $nationality,
				0, 1057, 810, 20, $gazoline);
		$engine48->addTank($tankRepo->getTankByName('T34'));
		$manager->persist($engine48);

		$engine49 = new Engine('Continental AV-1790-5B', $tier9, $nationality,
				80000, 569, 810, 20, $gazoline);
		$engine49->addTank($tankRepo->getTankByName('T54E1'));
		$engine49->addTank($tankRepo->getTankByName('M103'));
		$manager->persist($engine49);

		$engine50 = new Engine('AOI-1490', $tier10, $nationality, 100000, 1200,
				875, 20, $gazoline);
		...
		$engine51 = new Engine('Continental AV-1790-5', $tier10, $nationality,
				100000, 569, 860, 20, $gazoline);
		$engine51->addTank($tankRepo->getTankByName('T30'));
		$manager->persist($engine51);

		$engine52 = new Engine('Continental AV-1790-5C', $tier10, $nationality,
				99000, 11, 59, 810, 20, $gazoline);
		$engine52->addTank($tankRepo->getTankByName('T57 Heavy Tank'));
		$manager->persist($engine52);

		$engine53 = new Engine('Continental AV-1790-7B', $tier10, $nationality,
				100000, 569, 810, 12, $gazoline);
		$engine53->addTank($tankRepo->getTankByName('M48A1'));
		$manager->persist($engine53);

		$engine54 = new Engine('Continental AV-1790-7C', $tier10, $nationality,
				100000, 569, 860, 20, $gazoline);
		$engine54->addTank($tankRepo->getTankByName('M103'));
		$manager->persist($engine54);

		$engine55 = new Engine('Wright G200 M781 C9GC5', $tier10, $nationality,
				0, 612, 960, 20, $gazoline);
