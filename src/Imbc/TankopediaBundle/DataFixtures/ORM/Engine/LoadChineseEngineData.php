...
class LoadChineseEngineData extends AbstractFixture implements
	...
	public function load(ObjectManager $manager) {
		...
		$engine17 = new Engine('12150L-3', $tier7, $nationality, 0, 700, 430,
				12, $diesel);
		$engine17->addTank($tankRepo->getTankByName('Type 62'));
		$manager->persist($engine17);

		$engine18 = new Engine('12150L', $tier8, $nationality, 48000, 750, 520,
				12, $diesel);
		...
		$engine19 = new Engine('8V135', $tier8, $nationality, 43000, 740, 520,
				12, $diesel);
		$engine19->addTank($tankRepo->getTankByName('WZ-132'));
		$manager->persist($engine19);

		$engine20 = new Engine('NORINCO 12150L', $tier8, $nationality, 0, 750,
				520, 12, $diesel);
		$engine20->addTank($tankRepo->getTankByName('WZ-111'));
		$manager->persist($engine20);

		$engine21 = new Engine('NORINCO 12150L7', $tier9, $nationality, 0, 750,
				520, 12, $diesel);
		$engine21->addTank($tankRepo->getTankByName('Type 59'));
		$manager->persist($engine21);

		$engine22 = new Engine('12150LS', $tier9, $nationality, 99500, 750,
				580, 12, $diesel);
		...
		$engine23 = new Engine('12150LT', $tier10, $nationality, 120000, 750,
				600, 12, $diesel);
		...
		$engine24 = new Engine('12150L7', $tier10, $nationality, 25000, 935,
				580, 12, $diesel);
		$engine24->addTank($tankRepo->getTankByName('121'));
		$manager->persist($engine24);

		$engine25 = new Engine('V-2-54SC', $tier10, $nationality, 25000, 1045,
				750, 12, $diesel);
