...
class LoadRussianEngineData extends AbstractFixture implements
	...
	public function load(ObjectManager $manager) {
		...
		$engine5 = new Engine('GAZ-11', $tier2, $nationality, 810, 275, 80, 20,
				$gazoline);
		$engine5->addTank($tankRepo->getTankByName('SU-76'));
		$manager->persist($engine5);

		$engine6 = new Engine('T-26F', $tier2, $nationality, 1500, 545, 130,
				20, $gazoline);
		...
		$engine7 = new Engine('T-26M', $tier2, $nationality, 1230, 545, 100,
				20, $gazoline);
		...
		$engine18 = new Engine('M-17FO', $tier4, $nationality, 0, 610, 500, 20,
				$gazoline);
		$engine18->addTank($tankRepo->getTankByName('BT-SV'));
		$manager->persist($engine18);

		$engine19 = new Engine('M-17T', $tier4, $nationality, 10770, 610, 450,
				20, $gazoline);
		...
		$engine29 = new Engine('M-17E', $tier6, $nationality, 29300, 610, 550,
				20, $gazoline);
		$engine29->addTank($tankRepo->getTankByName('T-50'));
		$engine29->addTank($tankRepo->getTankByName('T-50-2'));
		$manager->persist($engine29);

		$engine30 = new Engine('V-2-34', $tier6, $nationality, 27860, 750, 500,
				15, $diesel);
		...
		$engine31 = new Engine('V-2-34M', $tier6, $nationality, 29500, 750,
				520, 15, $diesel);
		...
		$engine32 = new Engine('V-2K', $tier6, $nationality, 23050, 750, 500,
				15, $diesel);
		...
		$engine33 = new Engine('V-2KT', $tier6, $nationality, 0, 700, 650, 15,
				$diesel);
		...
		$engine34 = new Engine('V-44', $tier6, $nationality, 0, 750, 500, 15,
				$diesel);
		$engine34->addTank($tankRepo->getTankByName('SU-122-44'));
		$manager->persist($engine34);

		$engine35 = new Engine('V-5', $tier6, $nationality, 27860, 700, 560,
				15, $diesel);
		...
		$engine36 = new Engine('V-5U', $tier6, $nationality, 27860, 700, 580,
				15, $diesel);
		$engine36->addTank($tankRepo->getTankByName('Object 212'));
		$manager->persist($engine36);

		$engine37 = new Engine('V-2IS', $tier7, $nationality, 36000, 750, 600,
				15, $diesel);
		...
		$engine38 = new Engine('V-5F', $tier7, $nationality, 39000, 750, 700,
				15, $diesel);
		$engine38->addTank($tankRepo->getTankByName('T-150'));
		$manager->persist($engine38);

		$engine39 = new Engine('V-11', $tier8, $nationality, 55270, 750, 650,
				15, $diesel);
		...
		$engine40 = new Engine('V-2-44', $tier8, $nationality, 49740, 750, 560,
				12, $diesel);
		...
		$engine41 = new Engine('V-2SN', $tier8, $nationality, 17000, 750, 750,
				15, $diesel);
		$engine41->addTank($tankRepo->getTankByName('KV-3'));
		$manager->persist($engine41);

		$engine42 = new Engine('V-54K', $tier8, $nationality, 58000, 750, 600,
				12, $diesel);
		...
		$engine52 = new Engine('V-2-54IS', $tier9, $nationality, 79290, 700,
				700, 12, $diesel);
