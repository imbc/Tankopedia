...
class LoadFrenchEngineData extends AbstractFixture implements
	...
	public function load(ObjectManager $manager) {
		...
		$engine8 = new Engine('Renault 85', $tier1, $nationality, 1500, 300,
				38, 15, $diesel);
		$engine8->addTank($tankRepo->getTankByName('Renault UE 57'));
		$manager->persist($engine8);

		$engine9 = new Engine('Renault M26/27', $tier1, $nationality, 300, 266,
				45, 20, $gazoline);
		...
		$engine25 = new Engine('Sovam de 150 cv', $tier4, $nationality, 700,
				340, 150, 20, $gazoline);
		...
		$engine29 = new Engine('Somua S-40 Bis', $tier5, $nationality, 16100,
				400, 260, 20, $gazoline);
		...
		$engine30 = new Engine('Maybach HL 230', $tier6, $nationality, 26000,
				700, 575, 20, $gazoline);
		...
		$engine31 = new Engine('6F11SRY', $tier6, $nationality, 27000, 400,
				280, 15, $diesel);
		...
		$engine32 = new Engine('Maybach V-12 ACC', $tier6, $nationality, 0,
				750, 1000, 20, $gazoline);
		$engine32->addTank($tankRepo->getTankByName('FCM 50 t'));
		$manager->persist($engine32);

		$engine33 = new Engine('Detroit Diesel 6V53T', $tier7, $nationality,
				37000, 770, 300, 15, $diesel);
		...
		$engine34 = new Engine('Detroit Diesel 6V53T-S', $tier7, $nationality,
				39740, 770, 350, 12, $diesel);
		$engine34->addTank($tankRepo->getTankByName('AMX 13 90'));
		$manager->persist($engine34);

		$engine35 = new Engine('Maybach HL 230 P 45F', $tier8, $nationality,
		...
		$engine36 = new Engine('Maybach HL 234P45', $tier9, $nationality,
				98730, 750, 850, 20, $gazoline);
		...
		$engine37 = new Engine('Maybach HL 295', $tier9, $nationality, 78000,
				750, 850, 20, $gazoline);
		...
		$engine38 = new Engine('SOFAM 12GSds', $tier9, $nationality, 86050,
				2100, 680, 15, $diesel);
		$engine38->addTank($tankRepo->getTankByName('Bat Chatillon 155'));
		$manager->persist($engine38);

		$engine39 = new Engine('Saurer', $tier9, $nationality, 99800, 750,
				1000, 20, $gazoline);
		...
		$engine40 = new Engine('Hispano-Suiza HS110', $tier10, $nationality,
				94250, 2100, 720, 10, $diesel);
		...
		$engine41 = new Engine('Maybach HL 234P50', $tier10, $nationality,
				125000, 750, 980, 15, $gazoline);
		$engine41->addTank($tankRepo->getTankByName('Lorraine 40 t'));
		$manager->persist($engine41);

		$engine42 = new Engine('Maybach HL 295 F', $tier10, $nationality,
