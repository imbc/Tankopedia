...
class LoadBritishRadioData extends AbstractFixture implements
	...
	public function load(ObjectManager $manager) {
		...
		$radio5 = new Radio('WS No. 19 Mk. I', $tier6, $nationality, 15000, 40,
				400);
		...
		$radio6 = new Radio('WS No. 19 Mk. II', $tier7, $nationality, 21000,
				40, 450);
		...
		$radio7 = new Radio('WS No. 19 Mk. III', $tier8, $nationality, 22000,
				40, 550);
		...
		//         TOG II*, AT-15A"
		$radio9 = new Radio('WS No. 19 Special', $tier9, $nationality, 0, 40,
				570);
