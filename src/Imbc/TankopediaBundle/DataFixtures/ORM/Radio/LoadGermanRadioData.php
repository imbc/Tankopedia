...
class LoadGermanRadioData extends AbstractFixture implements
	...
	public function load(ObjectManager $manager) {
		...
		$radio6 = new Radio('FuG5 mit 20 WS.E.', $tier6, $nationality, 0, 50,
				620);
		...
		$radio10 = new Radio('FuG Spr. 1', $tier7, $nationality, 21600, 150,
				455);
		...
		//         VK 2801"
		$radio13 = new Radio('FuG Spr. A', $tier8, $nationality, 27000, 150,
				700);
