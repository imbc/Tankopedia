...
class LoadAmericanTrackData extends AbstractFixture implements
	...
	public function load(ObjectManager $manager) {
		...
		$track1 = new Track("Cunningham E1", $tier1, $nationality, 0, 2000,
				7.6, 34);
		...
		$track3 = new Track("Vickers E", $tier1, $nationality, 0, 2000, 11.1,
				42);
		$track3->addTank($tankRepo->getTankByName("T1E6"));
		$manager->persist($track3);

		$track4 = new Track("VVSS T36E6", $tier1, $nationality, 270, 3300,
				15.2, 18);
		$track4->addTank($tankRepo->getTankByName("T57"));
		$manager->persist($track4);

		$track5 = new Track("VVSS T16E1", $tier1, $nationality, 330, 3300,
				11.5, 36);
		...
		$track7 = new Track("Cunningham E2", $tier2, $nationality, 500, 2000,
				8.3, 38);
		...
		$track10 = new Track("VVSS T55E1", $tier2, $nationality, 550, 3300,
				16.3, 20);
		$track10->addTank($tankRepo->getTankByName("T57"));
		$manager->persist($track10);

		$track11 = new Track("VVSS T16E2", $tier2, $nationality, 620, 3300,
				11.5, 40);
		...
		$track13 = new Track("T82T55E2", $tier2, $nationality, 1850, 3000, 14,
				30);
		...
		$track15 = new Track("Stuart E1", $tier2, $nationality, 660, 3000,
				12.5, 40);
		...
		$track18 = new Track("T82T55E4", $tier3, $nationality, 740, 3000, 15.8,
				32);
		...
		$track28 = new Track("VVSS T48", $tier4, $nationality, 4650, 5000,
				29.9, 43);
		$track28->addTank($tankRepo->getTankByName("M3 Lee"));
		$manager->persist($track28);

		$track29 = new Track("T36 E6", $tier4, $nationality, 5850, 3000, 17.5,
				40);
		$track29->addTank($tankRepo->getTankByName("M8A1"));
		$manager->persist($track29);

		$track30 = new Track("VVSS T36E8", $tier4, $nationality, 5050, 3000,
				17.4, 45);
		$track30->addTank($tankRepo->getTankByName("M5 Stuart"));
		$manager->persist($track30);

		$track31 = new Track("VVSS T51", $tier4, $nationality, 4750, 6200,
				23.96, 20);
		...
		$track33 = new Track("VVSS T48", $tier4, $nationality, 4450, 4000,
				24.5, 46);
		$track33->addTank($tankRepo->getTankByName("M7"));
		$manager->persist($track33);

		$track34 = new Track("M10T41", $tier4, $nationality, 4300, 2000, 13.65,
				30);
		$track34->addTank($tankRepo->getTankByName("T49"));
		$manager->persist($track34);

		$track35 = new Track("M10T41", $tier4, $nationality, 4300, 7000, 28.49,
				28);
		$track35->addTank($tankRepo->getTankByName("M10 Wolverine"));
		$manager->persist($track35);

		$track36 = new Track("HVSS T31", $tier4, $nationality, 4050, 10600,
				57.88, 20);
		$track36->addTank($tankRepo->getTankByName("T1 Heavy Tank"));
		$manager->persist($track36);

		$track37 = new Track("M24T91", $tier4, $nationality, 4450, 4200, 18.3,
				42);
		...
		$track39 = new Track("M4A2E4T42", $tier5, $nationality, 0, 8000, 33.3,
				37);
		$track39->addTank($tankRepo->getTankByName("M4A2E4"));
		$manager->persist($track39);

		$track40 = new Track("VVSS WE210", $tier5, $nationality, 0, 8300, 31,
				37);
		...
		$track42 = new Track("VVSS T48A", $tier5, $nationality, 8000, 4000,
				25.5, 48);
		$track42->addTank($tankRepo->getTankByName("M7"));
		$manager->persist($track42);

		$track43 = new Track("VVSS T48M1A1", $tier5, $nationality, 8300, 5300,
				23.2, 58);
		$track43->addTank($tankRepo->getTankByName("T21"));
		$manager->persist($track43);

		$track44 = new Track("T49E2", $tier5, $nationality, 10200, 2000, 16.4,
				32);
		$track44->addTank($tankRepo->getTankByName("T49"));
		$manager->persist($track44);

		$track45 = new Track("M10T42", $tier5, $nationality, 10000, 7000, 31.7,
				30);
		$track45->addTank($tankRepo->getTankByName("M10 Wolverine"));
		$manager->persist($track45);

		$track46 = new Track("HVSS T35", $tier5, $nationality, 9600, 10600,
				61.5, 25);
		...
		$track67 = new Track("T84E1", $tier6, $nationality, 13400, 11500, 63.5,
				20);
		...
		$track69 = new Track("HVSS T51", $tier7, $nationality, 17900, 5400, 34,
				37);
		$track69->addTank($tankRepo->getTankByName("T20"));
		$manager->persist($track69);

		$track70 = new Track("T25/2T1", $tier7, $nationality, 19200, 10200,
				43.805, 30);
		$track70->addTank($tankRepo->getTankByName("T25/2"));
		$manager->persist($track70);

		$track71 = new Track("T25/2T4", $tier7, $nationality, 19200, 10200,
				45.8, 30);
		...
		$track73 = new Track("T84E3", $tier7, $nationality, 22000, 11500, 66.8,
				25);
