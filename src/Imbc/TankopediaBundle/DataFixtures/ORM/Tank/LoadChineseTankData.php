...
class LoadChineseTankData extends AbstractFixture implements
	...
	public function load(ObjectManager $manager) {
		...
		// light tanks
		$lt1 = new Tank('Renault NC-31', $light, $tier1, $nationality, FALSE,
				FALSE);
		$manager->persist($lt1);

		$lt2 = new Tank('Vickers Mk. E Type B', $light, $tier2, $nationality,
				FALSE, FALSE);
		$manager->persist($lt2);

		$lt3 = new Tank('Type 2597 Chi-Ha', $light, $tier3, $nationality,
				FALSE, FALSE);
		$manager->persist($lt3);

		$lt4 = new Tank('M5A1 Stuart', $light, $tier4, $nationality, FALSE,
				FALSE);
		$manager->persist($lt4);
		...
		// medium tanks
		$mt1 = new Tank('Type T-34', $medium, $tier5, $nationality, FALSE,
				FALSE);
		$manager->persist($mt1);
		...
		$ht4 = new Tank('WZ-111 model 1-4', $heavy, $tier9, $nationality,
				FALSE, FALSE);
		$manager->persist($ht4);
