...
class LoadFrenchTankData extends AbstractFixture implements
	...
	public function load(ObjectManager $manager) {
		...
		$lt3 = new Tank('Hotchkiss H35', $light, $tier2, $nationality, FALSE,
				FALSE);
		$manager->persist($lt3);
		...
		$mt2 = new Tank('Lorraine 40 t', $medium, $tier9, $nationality, FALSE,
				FALSE);
		$manager->persist($mt2);

		$mt3 = new Tank('Bat Chatillon 25 t', $medium, $tier10, $nationality,
				FALSE, FALSE);
		$manager->persist($mt3);
		...
		$ht4 = new Tank('AMX M4(1945)', $heavy, $tier7, $nationality, FALSE,
				FALSE);
		$manager->persist($ht4);

		$ht5 = new Tank('AMX 50 100', $heavy, $tier8, $nationality, FALSE,
				FALSE);
		$manager->persist($ht5);
		...
		$ht7 = new Tank('AMX 50 120', $heavy, $tier9, $nationality, FALSE,
				FALSE);
		$manager->persist($ht7);
		...
		$td3 = new Tank('Renault UE 57', $td, $tier3, $nationality, FALSE,
				FALSE);
		$manager->persist($td3);
		...
		$td7 = new Tank('AMX AC Mle. 1946', $td, $tier7, $nationality, FALSE,
				FALSE);
		$manager->persist($td7);

		$td8 = new Tank('AMX AC Mle. 1948', $td, $tier8, $nationality, FALSE,
				FALSE);
		$manager->persist($td8);
		...
		$td10 = new Tank('AMX-50 Foch (155)', $td, $tier10, $nationality,
				FALSE, FALSE);
		...
		$spg2 = new Tank('Lorraine39 L AM', $spg, $tier3, $nationality, FALSE,
				FALSE);
		$manager->persist($spg2);

		$spg3 = new Tank('105 leFH18B2', $spg, $tier4, $nationality, TRUE,
				FALSE);
		...
		$spg5 = new Tank('AMX 13 F3 AM', $spg, $tier5, $nationality, FALSE,
				FALSE);
		$manager->persist($spg5);

		$spg6 = new Tank('Lorraine155 50', $spg, $tier6, $nationality, FALSE,
				FALSE);
		$manager->persist($spg6);

		$spg7 = new Tank('Lorraine155 51', $spg, $tier7, $nationality, FALSE,
				FALSE);
		$manager->persist($spg7);

		$spg8 = new Tank('Bat Chatillon 155', $spg, $tier8, $nationality,
				FALSE, FALSE);
