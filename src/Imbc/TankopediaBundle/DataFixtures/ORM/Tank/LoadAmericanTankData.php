...
class LoadAmericanTankData extends AbstractFixture implements
	...
	public function load(ObjectManager $manager) {
		 ...
		 * Light Tanks
		 */
		$lt1 = new Tank('T1 Cunningham', $light, $tier1, $nationality, FALSE,
				FALSE);
		$manager->persist($lt1);

		$lt2 = new Tank('M2 Light Tank', $light, $tier2, $nationality, FALSE,
				FALSE);
		$manager->persist($lt2);
		...
		$lt4 = new Tank('T2 Light Tank', $light, $tier2, $nationality, TRUE,
				FALSE);
		$manager->persist($lt4);
		...
		$lt9 = new Tank('M24 Chaffee', $light, $tier5, $nationality, FALSE,
				FALSE);
		$manager->persist($lt9);
		 ...
		 * medium tanks
		 */
		$mt1 = new Tank('T2 Medium Tank', $medium, $tier2, $nationality, FALSE,
				FALSE);
		$manager->persist($mt1);

		$mt2 = new Tank('M2 Medium Tank', $medium, $tier3, $nationality, FALSE,
				FALSE);
		$manager->persist($mt2);
		...
		$mt4 = new Tank('M4 Sherman', $medium, $tier5, $nationality, FALSE,
				FALSE);
		$manager->persist($mt4);
		...
		$mt8 = new Tank('M4A3E2 Sherman Jumbo', $medium, $tier6, $nationality,
				FALSE, FALSE);
		$manager->persist($mt8);

		$mt9 = new Tank('M4A3E8 Sherman', $medium, $tier6, $nationality, FALSE,
				FALSE);
		$manager->persist($mt9);
		...
		$mt11 = new Tank('M26 Pershing', $medium, $tier8, $nationality, FALSE,
				FALSE);
		...
		$mt13 = new Tank('T26E4 Super Pershing', $medium, $tier8, $nationality,
				TRUE, FALSE);
		...
		$mt15 = new Tank('M46 Patton', $medium, $tier8, $nationality, FALSE,
				FALSE);
		 ...
		 * heavy tanks
		 */
		$ht1 = new Tank('T1 Heavy Tank', $heavy, $tier5, $nationality, FALSE,
				FALSE);
		$manager->persist($ht1);
		...
		$ht10 = new Tank('T57 Heavy Tank', $heavy, $tier10, $nationality,
				FALSE, FALSE);
		...
		$td5 = new Tank('M10 Wolverine', $td, $tier5, $nationality, FALSE,
				FALSE);
		$manager->persist($td5);
		...
		$td12 = new Tank('T28 Prototype', $td, $tier8, $nationality, FALSE,
				FALSE);
