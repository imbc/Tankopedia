...
class LoadBritishTankData extends AbstractFixture implements OrderedFixtureInterface
{
    ...
    public function load( ObjectManager $manager )
    {
         ...
         * light tanks
         */
        $lt1 = new Tank( 'Cruiser Mk. I', $light, $tier2, $nationality, FALSE, FALSE );
        $manager->persist( $lt1 );

        $lt2 = new Tank( 'Cruiser Mk. III', $light, $tier2, $nationality, FALSE, FALSE );
        $manager->persist( $lt2 );

        $lt3 = new Tank( 'Cruiser Mk. II', $light, $tier3, $nationality, FALSE, FALSE );
        $manager->persist( $lt3 );

        $lt4 = new Tank( 'Cruiser Mk. IV', $light, $tier3, $nationality, FALSE, FALSE );
        $manager->persist( $lt4 );

        $lt5 = new Tank( 'Covenanter', $light, $tier4, $nationality, FALSE, FALSE );
        $manager->persist( $lt5 );
         ...
         * medium tanks
         */
        $mt1 = new Tank( 'Vickers Medium Mk. I', $medium, $tier1, $nationality, FALSE, FALSE );
        $manager->persist( $mt1 );

        $mt2 = new Tank( 'Vickers Medium Mk. II', $medium, $tier2, $nationality, FALSE, FALSE );
        $manager->persist( $mt2 );

        $mt3 = new Tank( 'Vickers Medium Mk. III', $medium, $tier2, $nationality, FALSE, FALSE );
        $manager->persist( $mt3 );

        $mt4 = new Tank( 'Matilda', $medium, $tier4, $nationality, FALSE, FALSE );
        $manager->persist( $mt4 );

        $mt5 = new Tank( 'Matilda Black Prince', $medium, $tier5, $nationality, TRUE, FALSE );
        $manager->persist( $mt5 );
        ...
        $mt8 = new Tank( 'Centurion Mk. I', $medium, $tier8, $nationality, FALSE, FALSE );
        $manager->persist( $mt8 );

        $mt9 = new Tank( 'Centurion Mk. 7/1', $medium, $tier9, $nationality, FALSE, FALSE );
        $manager->persist( $mt9 );
         ...
         * heavy tanks
         */
        $ht1 = new Tank( 'Churchill I', $heavy, $tier5, $nationality, FALSE, FALSE );
        $manager->persist( $ht1 );

        $ht2 = new Tank( 'Churchill VII', $heavy, $tier6, $nationality, FALSE, FALSE );
        $manager->persist( $ht2 );

        $ht3 = new Tank( 'TOG II*', $heavy, $tier6, $nationality, TRUE, FALSE );
        $manager->persist( $ht3 );

        $ht4 = new Tank( 'Black Prince', $heavy, $tier7, $nationality, FALSE, FALSE );
        $manager->persist( $ht4 );

        $ht5 = new Tank( 'Caernarvon', $heavy, $tier8, $nationality, FALSE, FALSE );
        $manager->persist( $ht5 );
         ...
         * tank destroyers
         */
        $td1 = new Tank( 'Universal Carrier 2-pdr', $td, $tier2, $nationality, FALSE, FALSE );
        $manager->persist( $td1 );
        ...
        $td5 = new Tank( 'Churchill Gun Carrier', $td, $tier6, $nationality, FALSE, FALSE );
        $manager->persist( $td5 );
        ...
        $td11 = new Tank( 'FV215b (183)', $td, $tier10, $nationality, FALSE, FALSE );
