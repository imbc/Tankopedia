...
class Tank {
	 ...
	 * Constructor
	 */
	public function __construct($name = null, $class = null, $tier = null,
			$nationality = null, $premium = null, $reward = null) {
		if ($name !== null)
			$this->name = $name;
		if ($class !== null)
			$this->class = $class;
	...
	public function setClass(
			\Imbc\TankopediaBundle\Entity\TankClass $class = null) {
		$this->class = $class;
	...
	public function setNationality(
			\Imbc\TankopediaBundle\Entity\Nationality $nationality = null) {
		$this->nationality = $nationality;
	 ...
	 */
	public function addBattleTier(
			\Imbc\TankopediaBundle\Entity\Tier $battleTier) {
	 ...
	 * @param \Imbc\TankopediaBundle\Entity\Tier $battleTier
	 */
	public function removeBattleTier(
			\Imbc\TankopediaBundle\Entity\Tier $battleTier) {
		if ($this->matchMaker->contains($battleTier)) {
