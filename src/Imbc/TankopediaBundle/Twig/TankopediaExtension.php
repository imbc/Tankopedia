...
class TankopediaExtension extends \Twig_Extension
{
    ...
    public function getFunctions()
    {
        return array(
            ...
            'get_tankByNationalityAndTier' => new \Twig_Function_Method( $this, 'getTankByNationalityAndTier' )
        );
    }
    ...
    {
        return $this->em->getRepository( 'ImbcTankopediaBundle:Tank' )->getTankByTier( $tier );
    }

    public function getTankByType( $type )
    {
        return $this->em->getRepository( 'ImbcTankopediaBundle:Tank' )->getTankByType( $type );
    }

    public function getTankByNationality( $nationality )
    {
        return $this->em->getRepository( 'ImbcTankopediaBundle:Tank' )->getTankByNationality( $nationality );
    }
