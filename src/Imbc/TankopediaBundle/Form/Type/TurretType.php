...
class TurretType extends AbstractType {
	...
	public function buildForm(FormBuilderInterface $builder, array $options) {
		...
		$builder
				->add('armorFront', 'number', array('label' => 'Weight',));
		$builder
				->add('armorSide', 'number', array('label' => 'Weight',));
		$builder
				->add('armorRear', 'number', array('label' => 'Weight',));
		$builder
				->add('traverseSpeed', 'number', array('label' => 'Weight',));
		$builder
				->add('viewRange', 'number', array('label' => 'Weight',));
		$builder
				->add('tier', 'entity',
